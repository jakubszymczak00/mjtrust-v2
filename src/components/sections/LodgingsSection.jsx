...
const sochaczewImages =(
  import.meta.glob("/src/zdjecia/sochaczew/*.{jpg,JPG,png,jpeg,webp,WEBP}", {
    eager: true,
    import: "default",
  })
);
const mainsochaczew = sochaczewImages["/src/zdjecia/sochaczew/main.JPG"];

const blonieImages = Object.values(
  import.meta.glob("../../zdjecia/blonie/*.{jpg,png,jpeg,webp}", { eager: true, import: "default" })
);
const wpImages = Object.values(
  import.meta.glob("../../zdjecia/wp/*.{jpg,png,jpeg,webp}", { eager: true, import: "default" })
); 
console.log("Sochaczew images:", sochaczewImages);
console.log("sada:", mainsochaczew);
const LODGINGS = [
  {
    id: 1,
  ...
  },
  {
    ...
    image:
        mainsochaczew,
    gallery: Object.values(sochaczewImages),
  },
];
