...
import budynek1 from "../../zdjecia/budowa/1.jpg";
import budynek2 from "../../zdjecia/budowa/4.avif";
import budynek3 from "../../zdjecia/budowa/2.jpg";
import budynek4 from "../../zdjecia/budowa/3.jpg";
    ...
    >
      ...
      <FadeInSection delay={0.3}>
        <div className="relative z-10 mt-24 glass backdrop-blur-xl shadow-2xl border border-white/40 rounded-3xl p-16 max-w-3xl mx-auto">
          ...
          >
            ...
            własny parking oraz pełne zaplecze kuchenne i sanitarne.
          </motion.p>
        </div>
      </FadeInSection>
      ...
      <FadeInSection delay={0.5}>
        ...
        >
          ...
          {/* Galeria */}
          <motion.div
            className="relative z-10 flex gap-10 w-[150%] px-10"
            animate={{ x: ["0%", "-30%"] }}
            transition={{
              repeat: Infinity,
              duration: 30,
            ...
            {[...Array(2)].map((_, idx) => (
              <React.Fragment key={idx}>
                <img
                  src={budynek1}
                  alt="Budynek 1"
                  className="aspect-video w-700 max-w-[700px] rounded-3xl shadow-2xl object-cover"
                />
                <img
                  src={budynek2}
                  alt="Budynek 2"
